...
private:
    ...
    // Reflection-based actor introspection and viewport control (v1.9.0)
    ...
    // Viewport screenshot capture (v2.0.0). Queues an async PNG write via
    // FScreenshotRequest; returns the planned output path immediately.
